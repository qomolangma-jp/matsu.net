                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input"
                                       ...
                                       {{ (is_array(old('target_roles')) && in_array('year_admin', old('target_roles'))) || (is_array($news->target_roles) && in_array('year_admin', $news->target_roles)) ? 'checked' : '' }}>
